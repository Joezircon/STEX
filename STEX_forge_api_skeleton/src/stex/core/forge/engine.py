...
class ForgeEngine:
    ...
    - rib suggestion
    - export validation
    - multi-layer stencil checking

    Current v0.1 API:
    - load image
    - inspect white islands
    - return ForgeReport
    """
    ...
    def inspect_file(self, image_path: str) -> ForgeReport:
        """
        Load an image file and inspect it.
        """
    ...
    def inspect_array(self, rgb_array: np.ndarray) -> ForgeReport:
        """
        Inspect a RGB numpy image array.

        WHITE = stencil material that remains.
        BLACK = cutout / hole.
        Unsupported white islands are critical failures.
        """
    ...
    def _flood_from_edges(self, white_mask: np.ndarray) -> np.ndarray:
        """
        Return mask of white pixels connected to the outside border.
        """
